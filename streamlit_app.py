...
user_input_area = st.text_area("Enter the body of your e-mail:")

# Check if the user input is empty and handle the situation
if user_input_area.strip() == "":
    st.warning("Please enter some text to analyze.")
else:
    sentences = sent_tokenize(user_input_area)
    try:
        ...
        overall_res = chat_session.send_message(user_input_area)
